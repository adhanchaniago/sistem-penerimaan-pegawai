...
?>
			<div class="box-body" style="margin-top: 10px;">
				...
				<div class="form-group">
                    ...
                    <div class="col-md-8">
                    	<input type="text"  class="form-control" autofocus name="nama_kriteria" value="<?php echo $get->nama_kriteria ?>" placeholder="Nama Kriteria">
                ...
                <div class="form-group">
                   <label for="deskripsi" class="control-label col-md-3 col-xs-12">Jenis Kriteria : <strong class="text-red">*</strong></label>
                    <div class="col-md-8">
                    	<input type="text"  class="form-control" autofocus name="jenis_kriteria" value="<?php echo $get->jenis_kriteria ?>" placeholder="Jenis Kriteria">
