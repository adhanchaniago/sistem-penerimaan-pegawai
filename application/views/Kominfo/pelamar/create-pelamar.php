...
?>
			<div class="box-body" style="margin-top: 10px;">
				<div class="form-group">
					...
					<div class="col-md-4">
						<input type="text" name="no_invoice" class="form-control" value="<?php echo $kd_pelamar; ?>" readonly="readonly">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
				           ...
				           <input name="jenis_kelamin" type="radio" value="LAKI-LAKI" <?php if(set_value('jenis_kelamin')=='LAKI-LAKI') echo "checked"; ?>> <label for="gender"> Laki-laki</label>
				       	</div>
				       	<div class="radio radio-inline radio-primary">
				           <input name="jenis_kelamin" type="radio" value="PEREMPUAN" <?php if(set_value('jenis_kelamin')=='PEREMPUAN') echo "checked"; ?>> <label for="gender"> Perempuan</label>
				       	</div>
				...
				<div class="form-group">
					<label for="text" class="control-label col-md-3 col-xs-12">RW : <strong class="text-red">*</strong></label>
					<div class="col-md-6">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<select name="provinsi" class="form-control select2" id="provinsi">
                           <option>-- PILIH Provinsi --</option><?php foreach($provinsi as $prov){
