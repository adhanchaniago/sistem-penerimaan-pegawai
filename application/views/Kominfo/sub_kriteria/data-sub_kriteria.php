              ...
              <?php foreach ($sub_kriteria as $row) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="javascript:void(0)" id="delete-bobot" data-id="<?php echo $row->id_sub_kriteria ?>" class="btn btn-xs btn-danger" data-toggle="tooltip" data-placement="top" title="Hapus">
